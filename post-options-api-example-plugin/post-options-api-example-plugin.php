...
function post_options_api_example() {
	...
	require( dirname( __FILE__ ) . '/inc/post-options-api.1.0.1.php' );
	...
	$post_options->register_post_option( array( 
		...
		'callback' => $post_fields->text( array(
			...
			'sanitize_callback' => 'post_options_api_sanitize_callback',
...
// This function illustrates a custom sanitize callback
function post_options_api_sanitize_callback( $value, $args = array() ) {
	
	// Accepts an $args array too if needed, cames from whatever
	// is passed as sanitize_callback_args
